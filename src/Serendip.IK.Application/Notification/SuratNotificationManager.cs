...
namespace Serendip.IK.Notification
{
    public class SuratNotificationManager : ISuratNotificationService
    {
        ...
        private List<BaseSuratNotificationRequestDto> PrepareNotificationDto(LocalizableMessageNotificationData data, UserDto user)
        {
        ...
        public void PrepareNotification(LocalizableMessageNotificationData data, UserDto user)
        {
            var requestBody = new SuratNotificationRequestDto
            {
                Notifications = PrepareNotificationDto(data, user),
                TenantId = "0",
                        ...
                        case Channel.Push:
                            {
                                ...
                                // http://localhost:3000/knorm/detail?id=32
