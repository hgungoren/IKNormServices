...
{
    public abstract class IKWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IKWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IKWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IKDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IKDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IKDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IKDbContext, Task<T>> func)
        {
            T result;
